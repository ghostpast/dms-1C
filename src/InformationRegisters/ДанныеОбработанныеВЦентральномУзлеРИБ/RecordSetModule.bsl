...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если Количество() > 0
		...
		Отказ = Истина;
		ТекстИсключения = "Запись в РегистрСведений.ДанныеОбработанныеВЦентральномУзлеРИБ возможна только при отметке выполнения отложенного обработчика обновления информационной базы, который выполняется только в корневом узле.";
