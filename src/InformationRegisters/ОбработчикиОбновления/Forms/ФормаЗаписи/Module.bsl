...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Заголовок = "Обработчик обновления " + Запись.ИмяОбработчика;

	Если ЗначениеЗаполнено(Запись.Комментарий) Тогда
		Элементы.ГруппаКомментарий.Заголовок = "Комментарий *";
	Иначе
		Элементы.ГруппаКомментарий.Заголовок = "Комментарий";
	КонецЕсли;

	Если ЗначениеЗаполнено(Запись.ИнформацияОбОшибке) Тогда
		Элементы.ГруппаИнформацияОбОшибке.Заголовок = "Информация об ошибке *";
	Иначе
		Элементы.ГруппаИнформацияОбОшибке.Заголовок = "Информация об ошибке";
	КонецЕсли;

	ОбрабатываемыеДанные = "Открыть";
