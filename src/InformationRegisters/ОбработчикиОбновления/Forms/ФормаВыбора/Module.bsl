...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Заголовок = "Выбор обработчиков для перезапуска отложенного обновления";
...
Процедура СписокОбработчиковПередНачаломИзменения(Элемент, Отказ)
	Если Элемент <> Неопределено И Элемент.ТекущийЭлемент <> Неопределено И Элемент.ТекущийЭлемент.Имя = Элементы.Выбран.Имя Тогда
		Возврат;
	КонецЕсли;
