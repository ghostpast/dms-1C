...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("Расположение", Расположение) Тогда
		ВызватьИсключение "Не передан служебный параметр ""Расположение"".";
	КонецЕсли;
	...
	Иначе
		ВызватьИсключение СтрШаблон("Некорректное значение параметра ""Расположение"": ""%1"".", Строка(Расположение));
	КонецЕсли;
КонецПроцедуры
