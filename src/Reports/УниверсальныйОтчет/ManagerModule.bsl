...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ВариантыОтчетовСервер.ВО_УстановитьРежимВыводаВПанеляхОтчетов(Настройки, НастройкиОтчета, Ложь);

	НастройкиВарианта			= ВариантыОтчетовСервер.ВО_ОписаниеВарианта(Настройки, НастройкиОтчета, "Основной");
...
Функция ФиксированныеПараметры(Настройки, ПользовательскиеНастройки, ДоступныеЗначения) Экспорт
	...
	УстановитьФиксированныйПараметр("ТипОбъектаМетаданных", ФиксированныеПараметры, Настройки, ПользовательскиеНастройки, ДоступныеЗначения.ТипОбъектаМетаданных);

	ДоступныеЗначения.ИмяОбъектаМетаданных = ДоступныеОбъектыМетаданных(ФиксированныеПараметры.ТипОбъектаМетаданных);
	УстановитьФиксированныйПараметр("ИмяОбъектаМетаданных", ФиксированныеПараметры, Настройки, ПользовательскиеНастройки, ДоступныеЗначения.ИмяОбъектаМетаданных);

	ДоступныеЗначения.ИмяТаблицы = ДоступныеТаблицы(ФиксированныеПараметры.ТипОбъектаМетаданных, ФиксированныеПараметры.ИмяОбъектаМетаданных);
	УстановитьФиксированныйПараметр("ИмяТаблицы", ФиксированныеПараметры, Настройки, ПользовательскиеНастройки, ДоступныеЗначения.ИмяТаблицы);

	ФиксированныеПараметры.ИсточникДанных = ИсточникДанных(ФиксированныеПараметры.ТипОбъектаМетаданных, ФиксированныеПараметры.ИмяОбъектаМетаданных);
...
Процедура УстановитьФиксированныйПараметр(Идентификатор, Параметры, Настройки, ПользовательскиеНастройки, ДоступныеЗначения = Неопределено)
	...
	Если ТипЗнч(ПользовательскиеНастройки) = Тип("ПользовательскиеНастройкиКомпоновкиДанных") И (Настройки.ДополнительныеСвойства.Свойство("ОтчетИнициализирован") Или ПользовательскиеНастройки.ДополнительныеСвойства.Свойство("ОтчетИнициализирован")) Тогда
		ЭлементПользовательскойНастройки = ПользовательскиеНастройки.Элементы.Найти(ЭлементНастройки.ИдентификаторПользовательскойНастройки);
	КонецЕсли;

	Если ЭлементПользовательскойНастройки <> Неопределено И ДоступныеЗначения.НайтиПоЗначению(ЭлементПользовательскойНастройки.Значение) <> Неопределено Тогда
	...
	ИначеЕсли Идентификатор = "ИмяОбъектаМетаданных" И ЗначениеЗаполнено(Параметры.ИсточникДанных) Тогда
		ФиксированныйПараметр = Справочники.ИдентификаторыОбъектовМетаданных.ОбъектМетаданныхПоИдентификатору(Параметры.ИсточникДанных, Истина).Имя;
	ИначеЕсли ДоступныеЗначения.Количество() > 0 Тогда
		ФиксированныйПараметр = ДоступныеЗначения[0].Значение;
	ИначеЕсли ЭлементПользовательскойНастройки <> Неопределено И ЗначениеЗаполнено(ЭлементПользовательскойНастройки.Значение) Тогда
		ФиксированныйПараметр = ЭлементПользовательскойНастройки.Значение;
	ИначеЕсли ЗначениеЗаполнено(ЭлементНастройки.Значение) Тогда
		ФиксированныйПараметр = ЭлементНастройки.Значение;
	КонецЕсли;

	Если Идентификатор = "ТипОбъектаМетаданных" И ЗначениеЗаполнено(Параметры.ИсточникДанных) И Параметры.ИсточникДанных.ПолучитьОбъект() <> Неопределено Тогда
		ОбъектМетаданных		= МетаданныеИсточникаДанных(Параметры.ИсточникДанных);
		ТипОбъектаМетаданных	= БазоваяПодсистемаСервер.ОН_ИмяБазовогоТипаПоОбъектуМетаданных(ОбъектМетаданных);
...
Функция ТекстЗапросаПоМетаданным(ПараметрыОтчета)
	...
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "Документы" Или ПараметрыОтчета.ТипОбъектаМетаданных = "Задачи" Или ПараметрыОтчета.ТипОбъектаМетаданных = "БизнесПроцессы" Тогда
		Если ЗначениеЗаполнено(ПараметрыОтчета.ИмяТаблицы) И БазоваяПодсистемаКлиентСервер.ОН_ЕстьРеквизитИлиСвойствоОбъекта(МетаданныеИсточника, "ТабличныеЧасти") И БазоваяПодсистемаКлиентСервер.ОН_ЕстьРеквизитИлиСвойствоОбъекта(МетаданныеИсточника.ТабличныеЧасти, ПараметрыОтчета.ИмяТаблицы) Тогда
			ОтборИсточника = "
				|{ГДЕ
		...
		КонецЕсли;
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыСведений" И МетаданныеИсточника.ПериодичностьРегистраСведений <> Метаданные.СвойстваОбъектов.ПериодичностьРегистраСведений.Непериодический Тогда
		ОтборИсточника = "
			|{ГДЕ
			|	(Период МЕЖДУ &НачалоПериода И &КонецПериода)}";
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыНакопления" Или ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыБухгалтерии" Тогда
		ОтборИсточника = "
			|{ГДЕ
			|	(Период МЕЖДУ &НачалоПериода И &КонецПериода)}";
...
Функция ДоступныеТипыОбъектовМетаданных()
	...
	Если ЕстьОбъектыТипаМетаданных(Метаданные.Справочники) Тогда
		ДоступныеЗначения.Добавить("Справочники", "Справочник", , БиблиотекаКартинок.Справочник);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.Документы) Тогда
		ДоступныеЗначения.Добавить("Документы", "Документ", , БиблиотекаКартинок.Документ);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.РегистрыСведений) Тогда
		ДоступныеЗначения.Добавить("РегистрыСведений", "Регистр сведений", , БиблиотекаКартинок.РегистрСведений);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.РегистрыНакопления) Тогда
		ДоступныеЗначения.Добавить("РегистрыНакопления", "Регистр накопления", , БиблиотекаКартинок.РегистрНакопления);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.РегистрыБухгалтерии) Тогда
		ДоступныеЗначения.Добавить("РегистрыБухгалтерии", "Регистр бухгалтерии", , БиблиотекаКартинок.РегистрБухгалтерии);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.РегистрыРасчета) Тогда
		ДоступныеЗначения.Добавить("РегистрыРасчета", "Регистр расчета", , БиблиотекаКартинок.РегистрРасчета);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.ПланыВидовРасчета) Тогда
		ДоступныеЗначения.Добавить("ПланыВидовРасчета", "Планы видов расчета", , БиблиотекаКартинок.ПланВидовРасчета);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.Задачи) Тогда
		ДоступныеЗначения.Добавить("Задачи", "Задачи", , БиблиотекаКартинок.Задача);
	КонецЕсли;

	Если ЕстьОбъектыТипаМетаданных(Метаданные.БизнесПроцессы) Тогда
		ДоступныеЗначения.Добавить("БизнесПроцессы", "Бизнес-процессы", , БиблиотекаКартинок.БизнесПроцесс);
	КонецЕсли;
...
Функция ДоступныеОбъектыМетаданных(ТипОбъектаМетаданных)
	...
	Для Каждого Объект Из Метаданные[ТипОбъектаМетаданных] Цикл
		Если Не БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Объект) Или Не ПравоДоступа("Чтение", Объект) Тогда
			Продолжить;
		КонецЕсли;
...
Функция ДоступныеТаблицы(ТипОбъектаМетаданных, ИмяОбъектаМетаданных)
	...
	ДоступныеЗначения.Добавить("", "Основные данные");

	Если ТипОбъектаМетаданных = "Справочники" Или ТипОбъектаМетаданных = "Документы" Или ТипОбъектаМетаданных = "БизнесПроцессы" Или ТипОбъектаМетаданных = "Задачи" Тогда
	...
	ИначеЕсли ТипОбъектаМетаданных = "РегистрыСведений" Тогда
		Если ОбъектМетаданных.ПериодичностьРегистраСведений <> Метаданные.СвойстваОбъектов.ПериодичностьРегистраСведений.Непериодический Тогда
			ДоступныеЗначения.Добавить("СрезПоследних",	"Срез последних");
			ДоступныеЗначения.Добавить("СрезПервых",	"Срез первых");
		КонецЕсли;
	ИначеЕсли ТипОбъектаМетаданных = "РегистрыНакопления" Тогда
		Если ОбъектМетаданных.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Остатки Тогда
			ДоступныеЗначения.Добавить("ОстаткиИОбороты",	"Остатки и обороты");
			ДоступныеЗначения.Добавить("Остатки",			"Остатки");
			ДоступныеЗначения.Добавить("Обороты",			"Обороты");
		Иначе
			ДоступныеЗначения.Добавить("Обороты",			"Обороты");
		КонецЕсли;
	ИначеЕсли ТипОбъектаМетаданных = "РегистрыБухгалтерии" Тогда
		...
		ДоступныеЗначения.Добавить("Остатки",			"Остатки");
		ДоступныеЗначения.Добавить("Обороты",			"Обороты");
		ДоступныеЗначения.Добавить("ОборотыДтКт",		"Обороты Дт/Кт");
		ДоступныеЗначения.Добавить("ДвиженияССубконто",	"Движения с субконто");
	ИначеЕсли ТипОбъектаМетаданных = "РегистрыРасчета" Тогда
		Если ОбъектМетаданных.ПериодДействия Тогда
			ДоступныеЗначения.Добавить("ДанныеГрафика",				"Данные графика");
			ДоступныеЗначения.Добавить("ФактическийПериодДействия",	"Фактический период действия");
		КонецЕсли;
	ИначеЕсли ТипОбъектаМетаданных = "ПланыВидовРасчета" Тогда
		Если ОбъектМетаданных.ЗависимостьОтВидовРасчета <> Метаданные.СвойстваОбъектов.ИспользованиеБазыПланаВидовРасчета.НеИспользовать Тогда
			ДоступныеЗначения.Добавить("БазовыеВидыРасчета", "Базовые виды расчета");
		КонецЕсли;

		ДоступныеЗначения.Добавить("ВедущиеВидыРасчета", "Ведущие виды расчета");

		Если ОбъектМетаданных.ИспользованиеПериодаДействия Тогда
			ДоступныеЗначения.Добавить("ВытесняющиеВидыРасчета", "Вытесняющие виды расчета");
		КонецЕсли;
	КонецЕсли;
...
Функция ЕстьОбъектыТипаМетаданных(ТипМетаданных)
	Для каждого Объект Из ТипМетаданных Цикл
		Если БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Объект) И ПравоДоступа("Чтение", Объект) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
...
Процедура ДобавитьИтоги(ПараметрыОтчета, СхемаКомпоновкиДанных)
	...
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "Документы" ИЛИ ПараметрыОтчета.ТипОбъектаМетаданных = "Справочники" ИЛИ ПараметрыОтчета.ТипОбъектаМетаданных = "БизнесПроцессы" ИЛИ ПараметрыОтчета.ТипОбъектаМетаданных = "Задачи" Тогда
...
Процедура ДобавитьИтогиОбъекта(Знач ПараметрыОтчета, Знач СхемаКомпоновкиДанных)
	...
	ИначеЕсли ЗначениеЗаполнено(ОбъектМетаданных.ПредставлениеОбъекта) Тогда
		ПредставлениеОбъекта = БазоваяПодсистемаСервер.ОН_ПредставлениеОбъекта(ОбъектМетаданных);
	КонецЕсли;
	...
	Для каждого Реквизит Из ОбъектМетаданных.Реквизиты Цикл
		Если Не БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Реквизит) Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ДобавитьИтогиРегистра(Знач ПараметрыОтчета, Знач СхемаКомпоновкиДанных)
	...
	Для каждого Измерение Из ОбъектМетаданных.Измерения Цикл
		Если БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Измерение) Тогда
	...
	Если ПустаяСтрока(ПараметрыОтчета.ИмяТаблицы) Тогда
		Для каждого Реквизит Из ОбъектМетаданных.Реквизиты Цикл
			Если БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Реквизит) Тогда
				ДобавитьПолеНабораДанных(СхемаКомпоновкиДанных.НаборыДанных[0], Реквизит.Имя, Реквизит.Синоним);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
	...
	Для каждого Ресурс Из ОбъектМетаданных.Ресурсы Цикл
		Если Не БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Ресурс) Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ДобавитьИтогиКоличестваПодчиненныхЗаписей(СхемаКомпоновкиДанных)
	...
	ВычисляемоеПоле.Заголовок	= "Количество записей";
...
Процедура ДобавитьПоказатели(ПараметрыОтчета, НастройкиКД)
	...
	Если ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыНакопления" Тогда
		Для Каждого Измерение Из ОбъектМетаданных.Измерения Цикл
			Если Не БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Измерение) Тогда
				Продолжить;
			КонецЕсли;

			ВыбранныеПоля = НастройкиКД.Выбор;
			ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Измерение.Имя);
		КонецЦикла;
		Для Каждого Ресурс Из ОбъектМетаданных.Ресурсы Цикл
			Если Не БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Ресурс) Тогда
				Продолжить;
			...
			ВыбранныеПоля = НастройкиКД.Выбор;
			Если ПараметрыОтчета.ИмяТаблицы = "Обороты" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "Оборот", Ресурс.Синоним);
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "Остатки" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "Остаток", Ресурс.Синоним);
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "ОстаткиИОбороты" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляНачальныйОстаток, Ресурс.Имя + "НачальныйОстаток", Ресурс.Синоним);
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляПриход, Ресурс.Имя + "Приход", Ресурс.Синоним);
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляРасход, Ресурс.Имя + "Расход", Ресурс.Синоним);
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляКонечныйОстаток, Ресурс.Имя + "КонечныйОстаток", Ресурс.Синоним);
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя);
			КонецЕсли;
		КонецЦикла;
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыРасчета" Тогда
		Для Каждого Измерение Из ОбъектМетаданных.Измерения Цикл
	...
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыБухгалтерии" Тогда
		Для Каждого Ресурс Из ОбъектМетаданных.Ресурсы Цикл
			...
			ВыбранныеПоля = НастройкиКД.Выбор;
			Если ПараметрыОтчета.ИмяТаблицы = "Обороты" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "ОборотДт", Ресурс.Синоним + " " + "оборот Дт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "ОборотКт", Ресурс.Синоним + " " + "оборот Кт");
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "ОборотыДтКт" Тогда
				Если Ресурс.Балансовый Тогда
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "Оборот", Ресурс.Синоним + " " + "оборот");
				Иначе
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "ОборотДт", Ресурс.Синоним + " " + "оборот Дт");
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "ОборотКт", Ресурс.Синоним + " " + "оборот Кт");
				КонецЕсли;
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "Остатки" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "ОстатокДт", Ресурс.Синоним + " " + "ост. Дт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "ОстатокКт", Ресурс.Синоним + " " + "ост. Кт");
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "ОстаткиИОбороты" Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляНачальныйОстаток, Ресурс.Имя + "НачальныйОстатокДт", Ресурс.Синоним + " " + "нач. ост. Дт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляНачальныйОстаток, Ресурс.Имя + "НачальныйОстатокКт", Ресурс.Синоним + " " + "нач. ост. Кт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляОбороты, Ресурс.Имя + "ОборотДт", Ресурс.Синоним + " " + "оборот Дт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляОбороты, Ресурс.Имя + "ОборотКт", Ресурс.Синоним + " " + "оборот Кт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляКонечныйОстаток, Ресурс.Имя + "КонечныйОстатокДт", " " + Ресурс.Синоним + "кон. ост. Дт");
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоляКонечныйОстаток, Ресурс.Имя + "КонечныйОстатокКт", " " + Ресурс.Синоним + "кон. ост. Кт");
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "ДвиженияССубконто" Тогда
				Если Ресурс.Балансовый Тогда
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя, Ресурс.Синоним);
				Иначе
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "Дт", Ресурс.Синоним + " " + "Дт");
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя + "Кт", Ресурс.Синоним + " " + "Кт");
				КонецЕсли;
			ИначеЕсли ПараметрыОтчета.ИмяТаблицы = "" Тогда
				Если Ресурс.Балансовый Тогда
					ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Ресурс.Имя, Ресурс.Синоним);
	...
	ИначеЕсли ПараметрыОтчета.ТипОбъектаМетаданных = "Документы" ИЛИ ПараметрыОтчета.ТипОбъектаМетаданных = "Задачи" ИЛИ ПараметрыОтчета.ТипОбъектаМетаданных = "БизнесПроцессы" ИЛИ ПараметрыОтчета.ТипОбъектаМетаданных = "Справочники" Тогда
		...
		КонецЕсли;
		ВыбранныеПоля = НастройкиКД.Выбор;
		ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, "Ссылка");
		Для каждого Реквизит Из ОбъектМетаданных.Реквизиты Цикл
			Если БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(Реквизит) Тогда
				ВариантыОтчетовСервер.О_ДобавитьВыбранноеПоле(ВыбранныеПоля, Реквизит.Имя);
			КонецЕсли;
		КонецЦикла;
...
Процедура СформироватьСтруктуру(ПараметрыОтчета, Схема, Настройки)
	...
	Если ТипыПолейИсточника <> Неопределено Тогда
		УточнятьСуффиксыПолей = ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыБухгалтерии" И (ПараметрыОтчета.ИмяТаблицы = "" Или ПараметрыОтчета.ИмяТаблицы = "ОборотыДтКт" Или ПараметрыОтчета.ИмяТаблицы = "ДвиженияССубконто");
		...
		Для Каждого ТипПолейИсточника Из ТипыПолейИсточника Цикл
			...
			Для Каждого МетаданныеПоля Из МетаданныеИсточника[ТипПолейИсточника] Цикл
				Если Не БазоваяПодсистемаСервер.ОН_ОбъектМетаданныхДоступенПоФункциональнымОпциям(МетаданныеПоля) Тогда
					Продолжить;
				КонецЕсли;

				Если ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыБухгалтерии" И МетаданныеПоля.ПризнакУчета <> Неопределено Тогда
					Продолжить;
				КонецЕсли;
...
Процедура УстановитьСтандартныеНастройки(Отчет, ФиксированныеПараметры, Настройки, ПользовательскиеНастройки) Экспорт
	ОтчетИнициализирован = БазоваяПодсистемаКлиентСервер.ОН_СвойствоСтруктуры(Настройки.ДополнительныеСвойства, "ОтчетИнициализирован", Ложь);
...
Процедура УстановитьСтандартныеНастройкиЗагруженнойСхемы(Отчет, ДвоичныеДанныеСхемы, Настройки, ПользовательскиеНастройки) Экспорт
	Если БазоваяПодсистемаКлиентСервер.ОН_СвойствоСтруктуры(Настройки.ДополнительныеСвойства, "ОтчетИнициализирован", Ложь) Тогда
		Возврат;
	КонецЕсли;
...
Процедура УстановитьИсточникДанныхВарианта(Вариант) Экспорт
	УниверсальныйОтчет = Справочники.ИдентификаторыОбъектовМетаданных.ИдентификаторОбъектаМетаданных(Метаданные.Отчеты.УниверсальныйОтчет, Истина);
	...
	Попытка
		...
		Если НастройкиВарианта = Неопределено Тогда
			ОтменитьТранзакцию();
			ОбновлениеВерсииИБСервер.ОИБ_ОтметитьВыполнениеОбработки(Вариант);

			Возврат;
		КонецЕсли;

		ВариантОбъект.Настройки = Новый ХранилищеЗначения(НастройкиВарианта);
		ОбновлениеВерсииИБСервер.ОИБ_ЗаписатьДанные(ВариантОбъект);
...
Функция НастройкиВарианта(Вариант)
	...
	ИмяОбъекта = БазоваяПодсистемаСервер.ОН_ЗначениеРеквизитаОбъекта(ПараметрыИскомые.ИсточникДанных, "Имя");
...
Функция ИсточникДанных(ТипМенеджера, ИмяОбъекта)
	...
	Если Метаданные.НайтиПоПолномуИмени(ПолноеИмяОбъекта) = Неопределено Тогда
		ЗаписьЖурналаРегистрации("Варианты отчетов.Установка источника данных универсального отчета", УровеньЖурналаРегистрации.Ошибка, Метаданные.Справочники.ВариантыОтчетов,, СтрШаблон("Источник данных %1 отсутствует", ПолноеИмяОбъекта));

		Возврат Неопределено;
	КонецЕсли;

	Возврат Справочники.ИдентификаторыОбъектовМетаданных.ИдентификаторОбъектаМетаданных(ПолноеИмяОбъекта, Истина);
КонецФункции

Функция МетаданныеИсточникаДанных(ИсточникДанных)
	Попытка
		ОбъектМетаданных = Справочники.ИдентификаторыОбъектовМетаданных.ОбъектМетаданныхПоИдентификатору(ИсточникДанных, Истина);
	Исключение
		ВызватьИсключение СтрШаблон("Отчет не может быть сформирован по причине: %1", ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
...
Процедура УстановитьСтандартныйЗаголовокОтчета(Контекст, Настройки, ФиксированныеПараметры, ДоступныеЗначения) Экспорт
	...
	Если ЗначенияПараметров.Период <> Неопределено И ТипЗнч(ЗначенияПараметров.Период) = Тип("СтандартныйПериод") Тогда
		Период					= ЗначенияПараметров.Период; // СтандартныйПериод
		ПредставлениеПериода	= БазоваяПодсистемаКлиентСервер.сОН_ПредставлениеПериодаВТексте(Период.ДатаНачала, Период.ДатаОкончания, "", Ложь);
	КонецЕсли;

	Если ЗначенияПараметров.ТипОбъектаМетаданных = Неопределено И ЗначенияПараметров.ИмяОбъектаМетаданных = Неопределено И ЗначенияПараметров.ИмяТаблицы = Неопределено Тогда
	...
	ИначеЕсли ЗначенияПараметров.ИмяТаблицы = Неопределено И Не ЗначениеЗаполнено(ПредставлениеПериода) Тогда
		Заголовок = СтрШаблон("Универсальный отчет: %1 ""%2""", ЗначенияПараметров.ТипОбъектаМетаданных, ЗначенияПараметров.ИмяОбъектаМетаданных);
	ИначеЕсли ЗначенияПараметров.ИмяТаблицы <> Неопределено И Не ЗначениеЗаполнено(ПредставлениеПериода) Тогда
		Заголовок = СтрШаблон("Универсальный отчет: %1 ""%2"" - таблица ""%3""", ЗначенияПараметров.ТипОбъектаМетаданных, ЗначенияПараметров.ИмяОбъектаМетаданных, ЗначенияПараметров.ИмяТаблицы);
	ИначеЕсли ЗначенияПараметров.ИмяТаблицы = Неопределено И ЗначениеЗаполнено(ПредставлениеПериода) Тогда
		Заголовок = СтрШаблон("Универсальный отчет: %1 ""%2"" за %3", ЗначенияПараметров.ТипОбъектаМетаданных, ЗначенияПараметров.ИмяОбъектаМетаданных, ПредставлениеПериода);
	Иначе
		Заголовок = СтрШаблон("Универсальный отчет: %1 ""%2"" - таблица ""%3"" за %4", ЗначенияПараметров.ТипОбъектаМетаданных, ЗначенияПараметров.ИмяОбъектаМетаданных, ЗначенияПараметров.ИмяТаблицы, ПредставлениеПериода);
	КонецЕсли;

	ЗаголовокУстановленИнтерактивно = БазоваяПодсистемаКлиентСервер.ОН_СвойствоСтруктуры(Настройки.ДополнительныеСвойства, "ЗаголовокУстановленИнтерактивно", Ложь);
...
Функция УстановкаСтандартногоЗаголовкаОтчетаДоступна(Контекст)
	...
	Возврат ВариантыОтчетовСервер.ВО_ЭтоПредопределенныйВариантОтчета(ВариантОтчета);
КонецФункции
...
Функция ЗначенияПараметровСтандартногоЗаголовка(Контекст, ФиксированныеПараметры, ДоступныеЗначения)
	...
	Если ТипЗнч(Контекст) = Тип("ФормаКлиентскогоПриложения") Тогда
		АдресСхемы = БазоваяПодсистемаКлиентСервер.ОН_СвойствоСтруктуры(Контекст.НастройкиОтчета, "АдресСхемы");
	Иначе
	...
	Для Каждого Элемент Из ЗначенияПараметров Цикл
		...
		ДоступныеЗначенияПараметра = БазоваяПодсистемаКлиентСервер.ОН_СвойствоСтруктуры(ДоступныеЗначения, Элемент.Ключ);
...
Функция ВариантыИспользованияОформления()
	...
	Если БазоваяПодсистемаКлиентСервер.ОН_СравнитьВерсии(БазоваяПодсистемаСервер.СП_ВерсияРежимаСовместимости(), "8.3.16.0") < 0 Тогда
