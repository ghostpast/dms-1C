...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если ПользователиСервер.П_ЭтоПолноправныйПользователь() Тогда
		...
		Команда.Подсказка	= "Посмотреть зависимости выбранного обработчика";
		Команда.Картинка	= БиблиотекаКартинок.ЗатенитьФлажки;
		ВариантыОтчетовСервер.О_ВывестиКоманду(Форма, Команда, "Настройки");

		Команда				= Форма.Команды.Добавить("ПрогрессОтложенногоОбновленияОшибки");
		Команда.Действие	= "Подключаемый_Команда";
		Команда.Заголовок	= "Посмотреть ошибки";
		Команда.Подсказка	= "Посмотреть ошибки в журнале регистрации";
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	КонецЕсли;
	КешироватьРезультат = НастройкиКД.ПараметрыДанных.Элементы.Найти("КешироватьРезультат").Значение И НастройкиКД.ПараметрыДанных.Элементы.Найти("КешироватьРезультат").Использование;
...
Процедура ПриОпределенииПараметровВыбора(Форма, СвойстваНастройки) Экспорт
	Если СвойстваНастройки.ПолеКД = Новый ПолеКомпоновкиДанных("ПараметрыДанных.ПрогрессОбработки") Тогда
		СвойстваНастройки.ЗначенияДляВыбора.Добавить(Строка(НачалоДня(ТекущаяДатаСеанса())), "За весь период");
...
Функция ПредставлениеТипаМетаданных(ТипМетаданных)
	...
	Соответствие.Вставить("Константа",				"Константы");
	Соответствие.Вставить("Справочник",				"Справочники");
	Соответствие.Вставить("Документ",				"Документы");
	Соответствие.Вставить("ПланВидовХарактеристик",	"Планы видов характеристик");
	Соответствие.Вставить("ПланСчетов",				"Планы счетов");
	Соответствие.Вставить("ПланВидовРасчета",		"Планы видов расчета");
	Соответствие.Вставить("РегистрСведений",		"Регистры сведений");
	Соответствие.Вставить("РегистрНакопления",		"Регистры накопления");
	Соответствие.Вставить("РегистрБухгалтерии",		"Регистры бухгалтерии");
	Соответствие.Вставить("РегистрРасчета",			"Регистры расчета");
	Соответствие.Вставить("БизнесПроцесс",			"Бизнес процессы");
