...
Процедура ОтключитьНаСервере()
	...
	Попытка
		...
		ЭтоАвтономноеРабочееМесто		= Константы.РаботаВАвтономномРежиме.СоздатьМенеджерЗначения();
		ЭтоАвтономноеРабочееМесто.Прочитать();
		Если ЭтоАвтономноеРабочееМесто.Значение Тогда
			ЭтоАвтономноеРабочееМесто.Значение	= Ложь;
			ОбновлениеВерсииИБСервер.ОИБ_ЗаписатьДанные(ЭтоАвтономноеРабочееМесто);
		КонецЕсли;
