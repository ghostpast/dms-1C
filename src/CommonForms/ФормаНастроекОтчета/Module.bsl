...
Функция ПолучитьРодителяЭлементаНастройки(Знач СвойствоЭлементаСтруктуры, Знач ЭлементНастройки)
	...
	Если ЭлементНастройки <> Неопределено И ТипЭлемента <> Тип("ПолеГруппировкиКомпоновкиДанных") И ТипЭлемента <> Тип("АвтоЭлементПорядкаКомпоновкиДанных") И ТипЭлемента <> Тип("ЭлементПорядкаКомпоновкиДанных") И ТипЭлемента <> Тип("ЭлементУсловногоОформленияКомпоновкиДанных") И ТипЭлемента <> Тип("КоллекцияЭлементовСтруктурыТаблицыКомпоновкиДанных") Тогда
