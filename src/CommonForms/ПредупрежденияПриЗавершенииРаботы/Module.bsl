...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КлючСохраненияПоложенияОкна = "ПредупрежденияПриЗавершенииРаботы" + БазоваяПодсистемаСервер.ОН_КонтрольнаяСуммаСтрокой(Ключ);
...
Процедура ИнициализироватьЭлементыВФорме(Знач Предупреждения)
	...
	// Подвал.
	ТекстНадписи = "Завершить работу с программой?";
