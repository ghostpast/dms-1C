...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ЗначениеЗаполнено(Параметры.НазваниеРегиона) Тогда
		ТекстВопроса				= "Для автоподбора и выбора адресных сведений загрузите классификатор по региону ""%1"".";
		Элементы.Надпись.Заголовок	= СтрШаблон(ТекстВопроса, Параметры.НазваниеРегиона);
	КонецЕсли;
КонецПроцедуры
