...
Процедура ЗавершитьОбновлениеИнформационнойБазы(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Статус = "Выполнено"  Тогда
		УточнитьРезультатВыполнения(Результат.АдресРезультата, Результат.КраткоеПредставлениеОшибки, Результат.ПодробноеПредставлениеОшибки, ПризнакВыполненияОбработчиков, ПрогрессВыполнения);
...
Процедура УточнитьРезультатВыполнения(АдресРезультата, КраткоеПредставлениеОшибки, ПодробноеПредставлениеОшибки, ПризнакВыполненияОбработчиков, ПрогрессВыполнения)
	...
	ОбновлениеВерсииИБСервер.сОИБ_УстановитьЗапускОбновленияИнформационнойБазы(Ложь);
