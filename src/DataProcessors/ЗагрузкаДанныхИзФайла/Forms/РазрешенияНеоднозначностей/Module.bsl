...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ТипЗагрузки = "ТабличнаяЧасть" И ЗначениеЗаполнено(Параметры.ПолноеИмяТабличнойЧасти) Тогда
		...
		МассивОбъекта = СтрРазделить(Параметры.ПолноеИмяТабличнойЧасти, ".");
		...
		Элементы.ДекорацияЗаголовок.Заголовок				= СтрШаблон(Элементы.ДекорацияЗаголовок.Заголовок, Параметры.Имя);
	...
	Если Параметры.ТипЗагрузки = "ВставкаИзБуфераОбмена" Тогда
		...
		КонецЕсли;
		Элементы.ДекорацияЗаголовокПоискСсылок.Заголовок = СтрШаблон(Элементы.ДекорацияЗаголовокПоискСсылок.Заголовок, СтрокаСоЗначениями);
	Иначе
