...
Функция сКФ_ФормулаИзПредставления(Форма, ПредставлениеФормулы) Экспорт
	ЭлементыФормулы	= КонструкторФормулКлиентСервер.КФ_ЭлементыФормулы(ПредставлениеФормулы);
...
Функция сКФ_ПредставлениеФормулы(Форма, Формула) Экспорт
	ЭлементыФормулы	= КонструкторФормулКлиентСервер.КФ_ЭлементыФормулы(Формула);
	Выражение		= Формула;
