...
Процедура О_ПерегруппироватьЭлементыФормыНастроек(Форма, Знач УзелИерархииЭлементов, СвойстваЭлементов, ИменаРеквизитов, ВидыСтилизованныхЭлементов)
	...
	О_ДобавитьОтступКолонок(Форма, ЭлементыНастроек, УзелИерархииЭлементов, ЭтоОсновнаяФорма);
КонецПроцедуры

Процедура О_ДобавитьОтступКолонок(Форма, ЭлементыНастроек, УзелИерархииЭлементов, ЭтоОсновнаяФорма)
