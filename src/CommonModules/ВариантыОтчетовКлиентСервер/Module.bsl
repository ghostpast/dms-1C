...
Функция ВО_СвойстваСохраненияВариантаОтчета() Экспорт
...
Функция сВО_ГруппировкаФильтра(Настройки, СвойстваЗаголовка) Экспорт
...
Функция сВО_ФильтрыРазделаОтчета(Настройки, СвойстваЗаголовка) Экспорт
	ГруппировкаФильтра = сВО_ГруппировкаФильтра(Настройки, СвойстваЗаголовка);

	Возврат ГруппировкаФильтра.Отбор;
КонецФункции

Функция сВО_ФильтрРазделаОтчета(Фильтры, Поле) Экспорт
	Для Каждого Элемент Из Фильтры.Элементы Цикл
		Если ТипЗнч(Элемент) = Тип("ГруппаЭлементовОтбораКомпоновкиДанных") Тогда
			ЭлементыГруппы = Элемент.Элементы;

			Если ЭлементыГруппы.Количество() = 2 Или ЭлементыГруппы[0].ЛевоеЗначение = Поле Или ЭлементыГруппы[1].ЛевоеЗначение = Поле Тогда
				Возврат Элемент;
			КонецЕсли;
