...
Процедура сВО_ДобавитьФормулу(Настройки, КоллекцияПолей, ОписаниеФормулы) Экспорт
	...
	сВО_УстановитьСвойстваФормулы(Формула, ОписаниеФормулы);
...
Процедура сВО_ИзменитьФормулу(Форма, Настройки, ПутьКДанным, ИмяКоллекции = "ДоступныеПоляВыбора", ОбработатьВФорме = Ложь) Экспорт
	Формула = ВариантыОтчетовКлиентСервер.сВО_ФормулаПоПутиКДанным(Настройки, ПутьКДанным);
...
Процедура сВО_ПослеИзмененияФормулы(ОписаниеФормулы, Формула) Экспорт
	Если ТипЗнч(ОписаниеФормулы) <> Тип("Структура") Или Не ОписаниеФормулы.Свойство("Формула") Тогда
		Возврат;
	КонецЕсли;
...
Процедура сВО_УстановитьСвойстваФормулы(Формула, ОписаниеФормулы)
...
Процедура сВО_ПриАктивизацииРезультатаОтчета(Форма, Элемент) Экспорт
	...
	Элементы.КонтекстноеМенюОбластиДанных.Видимость				= Не Элементы.КонтекстноеМенюОбластиЗаголовка.Видимость И Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник И ЭтоРасшифровка;
