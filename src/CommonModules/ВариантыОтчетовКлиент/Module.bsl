...
Процедура сВО_ОпределитьВариантОтображениеКомандРедактированияТаблицы(Элементы, ЭтоРасшифровка)
#Если Не ВебКлиент Тогда

	Если Не ЭтоРасшифровка И (Элементы.КонтекстноеМенюОбластиЗаголовка.Видимость Или Элементы.КонтекстноеМенюОбластиДанных.Видимость) Тогда
...
Процедура сВО_ПриАктивизацииРезультатаОтчета(Форма, Элемент) Экспорт
	...
	сВО_ОпределитьВариантОтображениеКомандРедактированияТаблицы(Элементы, ЭтоРасшифровка);
