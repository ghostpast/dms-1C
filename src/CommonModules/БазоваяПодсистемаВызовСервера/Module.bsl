...
Процедура СП_ПроверитьПравоОтключитьЛогикуНачалаРаботыСистемы() Экспорт
	...
	ПользователиСервер.сП_ПроверитьПраваПользователя(ПользователиИнформационнойБазы.ТекущийПользователь(),
		"ПриЗапуске", ПользователиСерверПовтИсп.сП_ЭтоСеансВнешнегоПользователя());
КонецПроцедуры
