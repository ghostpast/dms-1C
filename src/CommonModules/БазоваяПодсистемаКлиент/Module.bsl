...
Процедура сОН_РассчитатьПоказатели(Форма, ИмяТабличногоДокумента, ТекущаяКоманда = "") Экспорт
	...
	// Расчет показателей.
	РасчетныеПоказатели = БазоваяПодсистемаКлиентСервер.ОН_РасчетныеПоказателиЯчеек(ТабличныйДокумент, ПолеТабличногоДокумента);
