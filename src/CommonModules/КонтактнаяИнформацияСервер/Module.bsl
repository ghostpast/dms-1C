...
Процедура УКИ_УстановитьНаименованиеВидаКонтактнойИнформации(Знач Объект, Наименование)
...
Процедура сУКИ_ИсправлениеУстаревшихАдресов() Экспорт
	...
	РСА_ВывитьИИсправитьУстаревшиеАдреса();
КонецПроцедуры
...
Процедура РСА_ВывитьИИсправитьУстаревшиеАдреса() Экспорт
	Возврат;
...
Функция РСА_РегионАдресаКонтактнойИнформации(Знач Адрес) Экспорт
	...
	ИначеЕсли ТипЗнч(Адрес) <> Тип("Структура") Тогда
		ВызватьИсключение "Невозможно определить субъекта РФ, ожидается адрес.";
	КонецЕсли;
