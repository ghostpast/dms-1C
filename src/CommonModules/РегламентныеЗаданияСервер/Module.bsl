...
Процедура РЗ_ИзменитьЗадание(Знач Идентификатор, Знач Параметры) Экспорт
	...
	Попытка
		...
		Если Задание <> Неопределено Тогда
			...
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "Наименование", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "Использование", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "Ключ", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "ИмяПользователя", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "ИнтервалПовтораПриАварийномЗавершении", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "КоличествоПовторовПриАварийномЗавершении", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "Параметры", ПараметрыЗадания, ЕстьИзменения);
			РЗ_ОбновитьЗначениеСвойстваЗадания(Задание, "Расписание", ПараметрыЗадания, ЕстьИзменения);
