...
Процедура ЗаполнитьРазделы()
	...
	ДеревоИсточник		= ВариантыОтчетовСерверПовтИсп.ВО_ПодсистемыТекущегоПользователя();
...
Функция ДанныеЗаполненияРазделов()
	...
	Запрос.УстановитьПараметр("ПолныеПраваНаВарианты",        ВариантыОтчетовСервер.ВО_ПолныеПраваНаВарианты());
	...
	Запрос.УстановитьПараметр("ОтчетыПользователя",           ВариантыОтчетовСервер.ВО_ОтчетыТекущегоПользователя());
