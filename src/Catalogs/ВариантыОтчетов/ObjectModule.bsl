...
Процедура ПриЗаписи(Отказ)
	...
	РегистрыСведений.НастройкиВариантовОтчетов.ЗаписатьНастройкиДоступностиВариантаОтчета(Ссылка, ЭтоНовый, ПользователиВарианта);
КонецПроцедуры
...
Процедура ПриЧтенииПредставленийНаСервере() Экспорт
	БазоваяПодсистемаСервер.М_ПриЧтенииПредставленийНаСервере(ЭтотОбъект);
КонецПроцедуры
