...
Функция ИсправитьПроблемуВФоне(ИдентификаторПроверки)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания	= "Исправление видов контактной информации";

	Возврат БазоваяПодсистемаСервер.ДО_ВыполнитьВФоне("КонтактнаяИнформацияСервер.сУКИ_ИсправитьВидыКонтактнойИнформацииВФоне", Новый Структура("ИдентификаторПроверки", ИдентификаторПроверки), ПараметрыВыполнения);
КонецФункции
...
Процедура ИсправитьПроблемуВФонеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Статус = "Выполнено" Тогда
		...
		Если ТипЗнч(Результат) = Тип("Структура") Тогда
			Элементы.ТекстИтогиИсправления.Заголовок = СтрШаблон(Элементы.ТекстИтогиИсправления.Заголовок, Результат.ИсправленоОбъектов, Результат.ВсегоОбъектов);
		КонецЕсли;
